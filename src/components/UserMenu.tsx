    ...
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-52">
          <DropdownMenuItem onClick={() => { setShowProfileModal(true); if (onCloseDrawer) setTimeout(onCloseDrawer, 50); }} className="gap-2 cursor-pointer">
            <UserCog className="w-4 h-4" />
            Profile
          </DropdownMenuItem>
          <DropdownMenuItem
            onClick={() => { handleSaveCurrent(); if (onCloseDrawer) setTimeout(onCloseDrawer, 50); }}
          ...
          <DropdownMenuItem
            onClick={() => { setShowSaveNewModal(true); if (onCloseDrawer) setTimeout(onCloseDrawer, 50); }}
          ...
          <DropdownMenuItem onClick={() => { setShowLoadModal(true); if (onCloseDrawer) setTimeout(onCloseDrawer, 50); }} className="gap-2 cursor-pointer">
            <FolderOpen className="w-4 h-4" />
            My Saved Loans
          </DropdownMenuItem>
          <DropdownMenuSeparator />
          <DropdownMenuItem onClick={() => { handleSignOut(); if (onCloseDrawer) setTimeout(onCloseDrawer, 50); }} className="gap-2 cursor-pointer text-destructive">
