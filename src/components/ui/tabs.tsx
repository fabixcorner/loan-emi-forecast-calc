...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-lg bg-card/80 p-1.5 text-muted-foreground gap-2 shadow-card border border-border",
      className
    )}
    {...props}
  />
